...
<head>
        ...
        <title>tehilla- Fashion eCommerce </title>
    ...
    <div class="panel-heading" id="stripes">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#payaccordion" href="#stripePay" aria-expanded="false" aria-controls="stripePay" class="btn btn-block custom-height bg-dark mb-2">
                <span>Check your size</span>
                <img src="assets/img/strip.html" class="img-fluid" alt="">
            </a>
        </h4>
        <div id="stripePay" class="collapse" aria-labelledby="stripes" data-parent="#payaccordion">
            <h4 class="panel-body">
                ...
                <h4 class="form-control">
                    <img src="assets/img/IMG_0696.png" alt="Card Holder Name" class="img-fluid" />
                </h4>
            </h4>
</div>
...
/* Active state for when the panel is opened */
.panel-collapse.show .size-link span {
    background-color: #fff; /* White background when the panel is open */
