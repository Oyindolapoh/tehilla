       ...
       <div class="preloader"></div>
        ...
        <div id="main-wrapper">
			...
			<div class="home-slider margin-bottom-0">
								...
								<div class="home-slider-container">
									...
									<div class="home-slider-desc">
										<div class="home-slider-title mb-4">
											<h5 class="theme-cl fs-sm ft-ragular mb-0">Tehilla Collection</h5>
											<h1 class="mb-1 ft-bold lg-heading">New december<br>Collections 2024</h1>
											<span class="trending">There's nothing like trend</span>
										</div>

										<a href="NGN" class="btn stretched-link borders">Shop Now<i class="lni lni-arrow-right ml-2"></i></a>
									</div>
									<!-- Slide Title / End -->
				...
				<!-- Slide -->
				<div data-background-image="assets/img/banner-5.png" class="item">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="home-slider-container">
					...
					<div class="row no-gutters exlio_gutters">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							<div class="single_cats">
								<a href="NGN" class="cards card-overflow card-scale lg_height">
							...
							<div class="single_cats">
								<a href="NGN" class="cards card-overflow card-scale md_height">
									<div class="bg-image" style="background:url(assets/img/b-5.png)no-repeat;"></div>
									<div class="ct_body">
										<div class="ct_body_caption left">	
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
							...
							<div class="row no-gutters">
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="single_cats">
										<a href="NGN" class="cards card-overflow card-scale md_height">
											<div class="bg-image" style="background:url(assets/img/b-3.png)no-repeat;"></div>
											<div class="ct_body">
												<div class="ct_body_caption left">	
									...
									<div class="single_cats">
										<a href="NGN" class="cards card-overflow card-scale lg_height">
											<div class="bg-image" style="background:url(assets/img/b-7.png)no-repeat;"></div>
											<div class="ct_body">
												<div class="ct_body_caption left">	
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							...
							<ul class="nav nav-tabs b-0 d-flex align-items-center justify-content-center simple_tab_links mb-4" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="all-tab" href="NGNall" data-toggle="tab" role="tab" aria-controls="all" aria-selected="true">All</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link active" href="NGNmens" id="mens-tab" data-toggle="tab" role="tab" aria-controls="mens" aria-selected="false">Men's</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="NGNwomen" id="women-tab" data-toggle="tab" role="tab" aria-controls="women" aria-selected="false">Women</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="NGNkids" id="kids-tab" data-toggle="tab" role="tab" aria-controls="kids" aria-selected="false">Kids</a>
								</li>
							</ul>
									...
									<div class="tab_product">
										<div class="row rows-products">
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Women Striped Shirt Dress</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN99 -  NGN129</span></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Boys Solid Sweatshirt</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN129</span></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Girls Floral Print Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN99 -  NGN129</span></div>
															</div>
														</div>
													</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Girls Solid A-Line Dress</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN50 -  NGN149</span></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Printed Straight Kurta</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN199</span></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Women Printed A-Line Dress</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN110 -  NGN600</span></div>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Girls Fit and Flare Dress</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN99 -  NGN110</span></div>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													<div class="badge bg-info text-white position-absolute ft-regular ab-left text-upper">New</div>
													<div class="badge bg-danger text-white position-absolute ft-regular ab-right text-upper">-</div>
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.php"><img class="card-img-top" src="assets/img/product/6.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Girls Self Design Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN119</span></div>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="row rows-products">
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.php"><img class="card-img-top" src="assets/img/product/13.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.php"><img class="card-img-top" src="assets/img/product/14.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php">Girls Self Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN119</span></div>
															</div>
														</div>
													</div>
									...
									<div class="tab_product">
										<div class="row rows-products">
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													<div class="badge bg-info text-white position-absolute ft-regular ab-left text-upper">New</div>
													<div class="badge bg-danger text-white position-absolute ft-regular ab-right text-upper">-610000000</div>
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.php"><img class="card-img-top" src="assets/img/product/9.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.php"> Self Design Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm"> NGN119</span></div>
															</div>
														</div>
													</div>
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="sec_title position-relative text-center">
								...
								<h3 class="ft-bold pt-3">Client Review</h3>
							</div>
						</div>
					</div>
									...
									<div class="prd_details">
										...
										<div class="prt_06">
											<p class="mb-0 d-flex align-items-center">
											  ...
											  <a class="d-inline-flex align-items-center justify-content-center p-3 gray circle fs-sm text-muted mr-2" href="NGN!">
												<i class="fab fa-twitter position-absolute"></i>
											  </a>
											  <a class="d-inline-flex align-items-center justify-content-center p-3 gray circle fs-sm text-muted mr-2" href="NGN!">
												<i class="fab fa-facebook-f position-absolute"></i>
											  </a>
											  <a class="d-inline-flex align-items-center justify-content-center p-3 gray circle fs-sm text-muted" href="NGN!">
							...
							<form>				
								...
								<div class="form-group">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div class="eltio_k2">
											<a href="NGN">Lost Your Password?</a>
										</div>	
									</div>
								</div>
								...
								<div class="form-group text-center mb-0">
									<p class="extra">Not a member?<a href="NGNet-register-wrap" class="text-dark"> Register</a></p>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="right-ch-sideBar">
						...
						<div class="cart_select_items py-2">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="NGN"><img src="assets/img/product/4.jpg" width="60" class="img-fluid" alt="" /></a>
									</div>
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="NGN"><img src="assets/img/product/7.jpg" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
							...
							<div class="d-flex align-items-center justify-content-between px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="NGN"><img src="assets/img/product/8.jpg" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
			...
			<a id="back2Top" class="top-scroll" title="Back to top" href="NGN"><i class="ti-arrow-up"></i></a>
