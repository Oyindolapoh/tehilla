...
<head>
    ...
    <div class="panel-heading size-link" id="stripes">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#payaccordion" href="#stripePay" aria-expanded="false" aria-controls="stripePay" class="btn btn-block custom-height mb-2">
                <span>Check your size</span>
                <i class="dropdown-icon">&#9660;</i> <!-- Unicode for down arrow -->
            </a>
        </h4>
    </div>
</div>
