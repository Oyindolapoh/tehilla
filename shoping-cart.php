									...
									<div class="row align-items-center">
										...
										<div class="col d-flex align-items-center justify-content-between">
											<div class="cart_single_caption pl-2">
												...
												<h4 class="fs-md ft-medium mb-3 lh-1">NGN129</h4>
							  ...
							  <div class="card-body">
								<ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Subtotal</span> <span class="ml-auto text-dark ft-medium">NGN98.12</span>
								  </li>
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Tax</span> <span class="ml-auto text-dark ft-medium">NGN10.10</span>
								  </li>
								  <li class="list-group-item d-flex text-dark fs-sm ft-regular">
									<span>Total</span> <span class="ml-auto text-dark ft-medium">NGN108.22</span>
								  </li>
...
<!-- Mirrored from themezhub.net/kumo-demo-2/kumo/shoping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Oct 2024 03:11:17 GMT -->
</html>