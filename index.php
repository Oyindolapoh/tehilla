				...
				<div class="container">
					<nav id="navigation" class="navigation navigation-landscape">
						<div class="nav-header">
							<a class="nav-brand" href="home-2.html">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="shop-style-1.html">Shop</a>
									
								
								<li><a href="shopping-cart.html">Cart</a>
										...
										<div class="row rows-products">
												...
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/2.jpg" alt="..."></a>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Women Striped Shirt Dress</a></h5>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/3.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Boys Solid Sweatshirt</a></h5>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/1.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Girls Floral Print Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
															</div>
														</div>
													</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/6.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Girls Solid A-Line Dress</a></h5>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/7.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Printed Straight Kurta</a></h5>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Women Printed A-Line Dress</a></h5>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/9.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Girls Fit and Flare Dress</a></h5>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html">Girls Self Design Jumpsuit</a></h5>
										...
										<div class="row rows-products">
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/10.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/11.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/12.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/13.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/14.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
										...
										<div class="row rows-products">
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/4.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/5.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
											...
											<div class="col-xl-3 col-lg-4 col-md-6 col-6">
												<div class="product_grid card b-0">
													...
													<div class="card-body p-0">
														<div class="shop_thumb position-relative">
															<a class="card-img-top d-block overflow-hidden" href="    shop-single-v2.html"><img class="card-img-top" src="assets/img/product/8.jpg" alt="..."></a>
															<div class="product-hover-overlay d-flex align-items-center justify-content-between">
																<div class="edlio"><a href="javascript:void(0);" class="text-underline fs-sm ft-bold snackbar-addcart">Add To Cart</a></div>
																<div class="edlio d-flex align-items-center">
																	<button class="btn auto btn_love mr-2 snackbar-wishlist"><i class="far fa-heart"></i></button>
													...
													<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
														<div class="text-left">
															<div class="text-left">
																...
																<h5 class="fs-md mb-0 lh-1 mb-1"><a href="    shop-single-v2.html"> Self Design Jumpsuit</a></h5>
																<div class="elis_rty"><span class="ft-bold text-dark fs-sm">$119</span></div>
															</div>
														</div>
													</div>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-12 col-md-12 text-center">
								<p class="mb-0">© 2024 Tehilla Designd By <a href="https://frontline11.com/">frontline</a>.</p>
							</div>
						</div>
					</div>
				</div>
